 ...
 *
 */
public final class HashCompareImage {
    /**
    ...
    public HashCompareImage(byte[] hashValue) {
    ...
    public HashCompareImage(String hashValue) {
        this(toBytes(hashValue));
    }
    public HashCompareImage (BufferedImage src){
        this(hashValue(src));
    }
    ...
    /**
     * 从压缩格式指纹创建{@link HashCompareImage}对象
     * @param compactValue
     * @return
     */
    public static HashCompareImage createFromCompact(byte[] compactValue){
        return new HashCompareImage(uncompact(compactValue));
    }
    ...
    public boolean equals(Object obj) {
        if(obj instanceof HashCompareImage){
            return Arrays.equals(this.binaryzationMatrix,((HashCompareImage)obj).binaryzationMatrix);
        }else
    ...
    public float compare(String hashValue){
        return compare(new HashCompareImage(hashValue));
    }
    /**
     * 与指定的指纹比较相似度
     * @param hashValue
    ...
    public float compare(BufferedImage image2){
        return compare(new HashCompareImage(image2));
    }
    /**
     * 比较指纹相似度
     * @param src
     ...
     */
    public float compare(HashCompareImage src){
    ...
    public static float compare(BufferedImage image1,BufferedImage image2){
        return new HashCompareImage(image1).compare(new HashCompareImage(image2));
    }
    
    public static void main(String[] args) throws IOException {
    	HashCompareImage fp1 = new HashCompareImage(ImageIO.read(new File("/users/yehaitao/desktop/h1.jpg")));
    	HashCompareImage fp2 =new HashCompareImage(ImageIO.read(new File("/users/yehaitao/desktop/p2.jpg")));
